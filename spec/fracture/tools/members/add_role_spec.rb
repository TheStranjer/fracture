...
RSpec.describe Fracture::Tools::AddRole do
  ...
  describe '.tool_name' do
    it 'is add_role' do
      expect(described_class.name_value).to eq('add_role')
    end
  end
  ...
  describe '.call' do
    ...
    before do
      ...
      allow(member).to receive(:add_role)
    end
    ...
    it 'adds the role to the member' do
      expect(member).to receive(:add_role).with(role)
